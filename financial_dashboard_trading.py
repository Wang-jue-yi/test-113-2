...
choices = ['元大50: 2020.1.2 至 2025.3.10', '中鋼期貨2025.12到期: 2023.4.17 至 2025.4.17', '聯電期貨2025.12到期: 2023.4.17 至 2025.4.17', '台積電期貨2020.3.2 至 2025.4.14', '富邦金期貨2023.4.17 至 2025.4.17','金融期貨2020.3.2至2025.4.14']
choice = st.selectbox('選擇金融商品', choices, index=0)
##### 读取Pickle文件
if choice == choices[0] :         ##'元大50: 2020.1.2 至 2025.3.10':
    df_original = load_data('kbars_15min_0050_2020-01-02_To_2025-03-10.pkl')
    product_name = '元大50 0050'
...
if choice == choices[1] :                   ##'大台指期貨2024.12到期: 2023.12 至 2024.4.11':
    df_original = load_data('kbars_15min_CBF_2023-04-17_To_2025-04-17.pkl')
    product_name = '中鋼期貨'
if choice == choices[2] :                              ##'小台指期貨2024.12到期: 2023.12 至 2024.4.11':
    df_original = load_data('kbars_15min_CCF_2023-04-17_To_2025-04-17.pkl')
    product_name = '聯電期貨'
if choice == choices[3] :                                           ##'英業達2020.1.2 至 2024.4.12':
    df_original = load_data('kbars_15min_CDF_2020-03-02_To_2025-04-14.pkl')
    product_name = '台積電期貨'
if choice == choices[4] :                                                       ##'堤維西2020.1.2 至 2024.4.12':
    df_original = load_data('kbars_15min_CEF_2023-04-17_To_2025-04-17.pkl')
    product_name = '富邦金期貨'
if choice == choices[5] :                                                      
    df_original = load_data('kbars_15min_FXF_2020-03-02_To_2025-04-14.pkl')
    product_name = '金融期貨'
...
if choice == choices[0] :                       ##'台積電: 2022.1.1 至 2024.4.9':
    start_date = st.text_input('輸入開始日期(日期格式: 2020-01-02), 區間:2022-01-02 至 2025-03-10', '2022-01-02')
    end_date = st.text_input('輸入結束日期 (日期格式: 2025-03-10), 區間:2022-01-02 至 2025-03-10', '2025-03-10')
if choice == choices[1] :                                   ##'大台指期貨2024.12到期: 2023.12 至 2024.4.11':
...
# #### 定義圖表
# matplotlib.rcParams['font.family'] = 'NotoSansJP-VariableFont_wght.ttf'
